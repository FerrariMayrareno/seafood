                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li>
                                    <a href="component-badge.html">Konfirmasi Pembayaran</a>
                                </li>

                                <li>
                                    <a href="component-breadcrumb.html">Pembayaran</a>
                                </li>

                                <li>
                                    <a href="component-buttons.html">Pengiriman</a>
                                </li>
            ...
            <div class="main-content container-fluid">
                ...
                <div class="card-body">                
                       <form method="POST" action="">    
                        ...
                        <button type="submit" class="btn btn-primary me-1 mb-1" name="btedit">Submit</button>
                    </div>
                       </form>
                       <?php

            $id_katalog  = $_GET['id_penawaran'];
                    if(isset($_POST['btedit']))
                        {
                            $bis                 = $_POST['idkatalog'];
                            $bisa                 = $_POST['tglpenawaran'];
                    
                        $edit = mysqli_query($db,"UPDATE penawaran 
                        SET id_katalog= '$bis',tgl_penawaran = '$bisa'
                        WHERE id_penawaran = ' $id_katalog'");
