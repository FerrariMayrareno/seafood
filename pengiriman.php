...
session_start();
  ...
  $pengiriman = mysqli_query($db, "SELECT * FROM pengiriman");
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">No resi</th>
                      <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">ID pembayaran</th>
                 ...
                 <tbody>
                    ...
                    <?php
                     ...
                     $id      = $data['no_resi']; 
                     $user   = mysqli_query($db, "SELECT * FROM pengiriman WHERE no_resi = '$id'");
                    ...
                    <tr>
                      ...
                      <?php if($status == 0){
                        ?>
                        <a href="verif.php?id=<?php echo $id; ?>" class="btn" style="background-color: green;color:white;">konfirmasi</a>
